 ...
 */
final class Version20200319153404 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE notebook_skill (id INT AUTO_INCREMENT NOT NULL, task_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_AC4B58C8DB60186 (task_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_subject (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, INDEX IDX_A3C32070A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE notebook_skill ADD CONSTRAINT FK_AC4B58C8DB60186 FOREIGN KEY (task_id) REFERENCES notebook_task (id)');
        ...
        $this->addSql('ALTER TABLE notebook_task ADD CONSTRAINT FK_757809D323EDC87 FOREIGN KEY (subject_id) REFERENCES user_subject (id)');
        ...
        $this->addSql('ALTER TABLE timetable_task ADD CONSTRAINT FK_C742312B23EDC87 FOREIGN KEY (subject_id) REFERENCES user_subject (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notebook_skill DROP FOREIGN KEY FK_AC4B58C8DB60186');
